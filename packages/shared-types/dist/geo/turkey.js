...
exports.TURKEY_PROVINCES = void 0;
exports.normalizeCityName = normalizeCityName;
exports.findProvinceByCityName = findProvinceByCityName;
exports.findDistrictInProvince = findDistrictInProvince;
exports.TURKEY_PROVINCES = [
...
const PROVINCE_BY_NORMALIZED_NAME = new Map(exports.TURKEY_PROVINCES.map((p) => [normalizeCityName(p.name), p]));
function findProvinceByCityName(cityName) {
    if (!cityName)
        return null;
...
function findDistrictInProvince(province, districtName) {
