...
const SURVEY_QUESTIONS: Record<WorkplaceType, SurveyQuestion[]> = {
  ...
  REMOTE: [
    // Corporate Culture
    q("REMOTE", "corporateCulture", 1, "Does management trust remote employees without using digital tracking or surveillance software?", "YES"),
    q("REMOTE", "corporateCulture", 2, "Do in-office employees receive preferential treatment or faster promotions over remote staff?", "NO"),
    q("REMOTE", "corporateCulture", 3, "Does the company respect asynchronous communication, allowing time to reply without pressure?", "YES"),
    q("REMOTE", "corporateCulture", 4, "Does management respect your local timezone boundaries when scheduling calls or assigning tasks?", "YES"),
    q("REMOTE", "corporateCulture", 5, "Is remote socialization purely optional without social penalties for non-attendance?", "YES"),
    // Leadership & Management
    q("REMOTE", "leadership", 1, "Does leadership evaluate your performance strictly by work outcomes rather than online activity dots?", "YES"),
    q("REMOTE", "leadership", 2, "Are virtual team meetings run with clear agendas and kept within set time limits?", "YES"),
    q("REMOTE", "leadership", 3, "Does your manager respond to messages and support requests within a reasonable timeframe?", "YES"),
    q("REMOTE", "leadership", 4, "Does leadership actively step in when a remote employee shows clear signs of burnout?", "YES"),
    q("REMOTE", "leadership", 5, "Is company leadership honest and transparent during virtual town halls and written updates?", "YES"),
    // Infrastructure & Resources
    q("REMOTE", "infrastructure", 1, "Did the company provide a proper stipend or high-quality hardware for your remote setup?", "YES"),
    q("REMOTE", "infrastructure", 2, "Are cloud tools, VPNs, and internal software reliable and fast to access?", "YES"),
    q("REMOTE", "infrastructure", 3, "Is internal company documentation clear enough for you to solve problems independently?", "YES"),
    q("REMOTE", "infrastructure", 4, "Can remote IT support fix account access or device issues without long delays?", "YES"),
    q("REMOTE", "infrastructure", 5, "Are digital collaboration tools (Slack, Teams, Jira) structured logically rather than chaotic?", "YES"),
    // Work-Life Balance
    q("REMOTE", "workLifeBalance", 1, "Do the lines between your personal life and workday frequently blur into unpaid work hours?", "NO"),
    q("REMOTE", "workLifeBalance", 2, "Can you step away from your computer during the day without feeling anxious about your status icon?", "YES"),
    q("REMOTE", "workLifeBalance", 3, 'Does the company enforce a genuine "right to disconnect" after your working day ends?', "YES"),
    q("REMOTE", "workLifeBalance", 4, "Is your assigned workload realistically manageable within a standard work week?", "YES"),
    q("REMOTE", "workLifeBalance", 5, "Are hybrid employees forced into mandatory in-office days that serve no practical purpose?", "NO"),
    // Organizational Stability
    q("REMOTE", "stability", 1, "Is there constant management talk or threats of forced Return-to-Office mandates?", "NO"),
    q("REMOTE", "stability", 2, "Are remote employees paid equally compared to in-office peers in the same role?", "YES"),
    q("REMOTE", "stability", 3, "Do fully remote workers have equal access to mentorship and career advancement?", "YES"),
    q("REMOTE", "stability", 4, "Is company financial performance communicated clearly and honestly to remote staff?", "YES"),
    q("REMOTE", "stability", 5, "Are you worried your remote role might be offshored or eliminated without warning?", "NO"),
  ],
  SERVICE: [
    // Corporate Culture
