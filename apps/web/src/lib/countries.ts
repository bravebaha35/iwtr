// All countries with ISO2 code, display name, phone dial code, and flag
// emoji — used for the registration country picker and the phone-number
// country-code selector, both in plain alphabetical order. Source: public
// gist countries.json (https://gist.github.com/devhammed/78cfbee0c36dfdaa4fce7e79c0d39208).
// Only Turkey has real city/district data (see lib/turkeyGeo.ts) — every
// other country falls back to free-text city/district entry.
...
export const COUNTRIES: Country[] = [
  ...
  { code: "CD", name: "Congo, The Democratic Republic of the Congo", dialCode: "+243", flag: "🇨🇩" },
  ...
  { code: "KP", name: "Korea, Democratic People's Republic of Korea", dialCode: "+850", flag: "🇰🇵" },
  { code: "KR", name: "Korea, Republic of South Korea", dialCode: "+82", flag: "🇰🇷" },
  ...
  { code: "FM", name: "Micronesia, Federated States of Micronesia", dialCode: "+691", flag: "🇫🇲" },
  ...
  { code: "TZ", name: "Tanzania, United Republic of Tanzania", dialCode: "+255", flag: "🇹🇿" },
